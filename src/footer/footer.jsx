        ...
        <div className="footer-wrap">
          ...
          <div className="footer-main">
                  ...
                  <div className="contact-detail">
                    ...
                    <span className="contact-value">
                      <a
                        ...
                        href="mailto:humammohammad76@gmail.com"
                      >
                        humammohammad76@gmail.com
                      </a>
                    </span>
                  </div>
                </div>
            ...
            <div className="footer-socails">
              <a href="https://www.facebook.com/share/1D8biYrB1r/?mibextid=wwXIfr">
                <img src={facebook} alt="فيسبوك" />
              </a>
              <a href="https://www.instagram.com/dr.humam_alassadi?igsh=MWVudXR0bHZjeWNxZw==">
                <img src={instagram} alt="instagram" />
              </a>
            </div>
          </div>
          <div className="footer-bottom">
            <div style={{ display:'flex' , flexDirection:'column' , justifyItems:'center', alignItems:'center', gap:'0.5rem'}}>
              <span>
                جميع الحقوق محفوظة <span>&#169;</span>2026{" "}
              </span>
              <span>
                تصميم و تطوير
                <a id="footer-nav-a" style={{marginRight: '0.25rem'}} href="https://namaaconsultancy.net/">
                  Al-Namaa for Business Solutions
                </a>
              </span>
            </div>
          </div>
